...
<main class="">
    ...
    <!-- about us start -->
    <section class="d-lg-flex justify-content-center align-items-center p-2">
    ...
    <section class="container-fluid my-5 p-2">
        ...
        <p class="text-center px-md-5 mb-3 font-poppins text-black-50">
            if you face any kind of difficulties any kind of problem or if you need any kind of information
            regarding
            any topic related to education field, contact with us we will be greatfull to talk to you.
        </p>

        <div class="row row-cols-1 row-cols-sm-2 g-2 mt-5 align-items-center">
